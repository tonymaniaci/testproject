...
public class WaitingRoomIonActivity extends Activity {
        ...
        Ion.with(this)
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        if (e != null) {
                            Toast.makeText(WaitingRoomIonActivity.this, "Error loading tweets", Toast.LENGTH_LONG).show();
                            return;
                        }
